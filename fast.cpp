...
int main(int aRgc, char **aRgv)
{
	...
	if(cmd.mVerboseLevel >= VERBOSE_INFO_OUTPUT)
	{
		...
		if(cmd.mHimmelblauTermination)				std::cout << "stopping criterion:	Himmelblau termination" << std::endl;
		else										std::cout << "stopping criterion:	function redution based" << std::endl;
...
-ae  --absolute-error (required argument)
