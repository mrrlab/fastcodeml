...
/// This class encapsulates all the routines needed to export in textual form
/// the forest of phylogenetic trees.
...
public:
  ...
  /// @param[in] aCounter Value to substitute \%d or \@d in filename (it is a
  /// printf format)
  ///
...
private:
  ...
  /// @param[out] aLength Resulting branch lengths to label branches in exported
  /// tree
  ///
