...
//		OPT_FORCE_SERIAL,
	...
	CSimpleOpt::SOption parser_options[] = {
		...
		{ OPT_VERBOSE,			"-v",					SO_REQ_SEP, "Verbosity level (0: none; 1: results only; 2: normal info; 3: MPI trace; 4: more debug) (default: 1)" },
	...
	//	{ OPT_BRANCH_END,		"--branch-end",			SO_REQ_SEP, "" },
		...
		{ OPT_BRANCH_ALL,		"-ba",					SO_NONE, "Do for all branches as foreground branch (including leaves)" },
		...
		{ OPT_INIT_PARAM,		"-p",					SO_REQ_SEP,	"Pass initialization parameter in the form: P=value (P: w0, k, p0, p1, w2) -> e.g. -p w0=1.1 -p p0=2.1 ..." },
