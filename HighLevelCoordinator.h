...
/// This class encapsulates MPI usage to parallelize FastCodeML above the
/// maximizer level.
///
...
private:
  ...
  size_t mNumInternalBranches; ///< Number of internal branches (i.e.\ the ones
                               ///that can be foreground branch)
